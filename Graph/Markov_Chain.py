...
class MarkovChainGraphUndirectedUnweighted:
    ...
    def add_transition_probability(self, node1: str, node2: str, probability: float) -> None:
...
def get_transitions(start: str, transition: list[tuple[str, str, float]], steps: int) -> dict[str, int]:
    """
    ...
    for node1, node2, probability in transition:
