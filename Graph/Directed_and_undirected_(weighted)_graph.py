...
class DirectedGraph:
    ...
    def topological_sort(self, s = -2):
        ...
        while True:
            ...
            # check if se have reachedc the starting point
            if len(stack) == 0:
                return sorted_nodes
    ...
    def cycle_nodes(self):
        ...
        while True:
            ...
            if len(self.graph[s]) != 0:
                ...
                for node in self.graph[s]:
                    if (
                        ...
                        and node[1] != parent
                        and indirected_parents.count(node[1]) > 0
            ...
            if s == ss:
                ...
                on_the_way_back = False
                indirected_parents.append(parent)
                parent = s
                s = ss
                ...
                for node in self.graph[s]:
                    if (
                        ...
                        while len_stack_minus_one >= 0:
                            if stack[len-len_stack_minus_one] == node[1]:
                                anticipating_nodes.add(node[1])
                                break
                            else:
                                return True
